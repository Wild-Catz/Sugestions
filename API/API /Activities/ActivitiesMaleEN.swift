...
extension APIService {
    internal static let activitiesMaleEN: [ActivityAPI] = [
            .init(id: 1,
                  name: "Pass me that",
                  description: """
            ...
            .init(id: 6,
                  ...
                  description: """
                    ...
                    Place the container with the cap on the left side of the child (right if he is left-handed) and the other one on the right, in a comfortable position.

                    For the first time you can start by showing the activity yourself, explaining to him what to do.

                    When it is the child’s turn, if he is struggling, you can start by guiding his hands to the caps and to the hole. You can even start by passing him the caps the first time.

                    After that try to reduce more and more the help given, to the point where he can do it by himself

                    At the end of the session you can reward the child with sweets or a more substantial reward of his choice.
                    """,
                  tips: ["This activity is also very useful for training the focus span. If the child is having trouble staying focused, start with a small number or caps, even just one. Then do the activity and reward him immediately after. The next time you can increase the number of caps.", "The table where you are doing the activity should be free from distractions and noise, if possible"],
            ...
            .init(id: 7,
                  ...
                  description: """
                    ...
                    When it is the child’s turn, give him a bottle. If he is struggling with the understanding of what cap to use, you can point at or hand him the correct one. If needed, guide the child’s hands through the screwing motion.

                    At the end of the session you can reward the child with sweets or a more substantial reward of his choice.
                    """,
                  tips: ["This activity is also very useful for training the focus span. If the child is having trouble staying focused, start with a small number of bottles, even just one. Then do the activity and reward him immediately after. The next time you can increase the number of bottles.", "The table where you are doing the activity should be free from distractions and noise, if possible.", "Use different kinds of bottles, for example the ones from detergent, after cleaning them up."],
            ...
            .init(id: 8,
                  ...
                  description: """
                    ...
                    When it is the child’s turn, show him the next image and ask him to place it in the correct categories. If the child is struggling, help him by guiding the hand to the right place. It is important to prevent errors, if the child is doing wrong, correct him.

                    Once the child will be more confident, you can start just pointing out the right category instead of guiding his hands. But don’t worry if this doesn’t happen during the first sessions, it could require time. At the end try without giving any hints.
            ...
            .init(id: 9,
                  ...
                  description: """
                    ...
                    When it is the child's turn, if he needs it, help him out by guiding his hands. If the child is struggling, you can tie a knot on the cord, to show him where to handle it.

                    Start with a small amount of beads, then try to raise the number.

                    At the end of the session you can reward him with sweets or a more substantial reward of his choice.
                    """,
                  tips: ["Try using this activity to make some bracelets for the child, in this way he can feel more rewarded after.", "If the child has a hard time staying focused, lower the number of beads required to get the reward, with the goal of using more beads the next time."],
            ...
            .init(id: 10,
                  ...
                  description: """
                    ...
                    If the child is having a hard time understanding what color to use, help him by pointing at the correct one or passing it to him.

                    Try not allowing any mistakes, if the child picks the wrong color or is doing the wrong shape, correct him,

                    At the end of the session you can reward the child with sweets or a more substantial reward of his choice.
                    """,
                  tips: ["The more the colors used, the more challenging it will be.", "If the activity is too simple for him you can try by changing the shape to a more complex one."],
                  need: "Coloured cubes",
            ...
            .init(id: 11,
                  ...
                  description: """
                    ...
                    At the end of the session you can reward the child with sweets or a more substantial reward of his choice.
                    """,
                  tips: ["The more the colors used, the more challenging it will be.", "You could use this activity also to introduce the child to the object portrayed in the image, if he doesn’t know what that is."],
            ...
            .init(id: 12,
                  ...
                  description: """
                    ...
                    First guiding very invasively, then gradually letting go and letting the child do it on his own.

                    In the end, when the child has pocketed each shape correctly, provide reinforcement.
                    """,
                  tips: ["Pay attention to position yourself so that you can comfortably intervene on the child's hand to guide him easily.", "If you don’t have a shape box, a variation could be done using a puzzle with interlocking pieces (not a regular puzzle)."],
                  need: "A shape box",
            ...
            .init(id: 14,
                  ...
                  description: """
                    ...
                    Make it clear what he has to do both verbally and with a practical example, and physically help the operation first in a very invasive way, then gradually less.
            ...
            .init(id: 15,
                  ...
                  description: """
                    Start by placing the first halves on the table to the left of the child and the remaining halves to their right. They should all be well spaced without overlapping, to facilitate recognition and movement.

                    Explain to the child the activity and show him how to do it. If needed, give the child a physical prompt to help him. When he feels more confident, scale back by just pointing at the right half or without any help.
                    ...
                    At the end of the session you can reward the child with sweets or a more substantial reward of his choice.
                    """,
                  tips: ["A variation is to place all the first halves in front of the child, well spaced, and next to them a bundle with the other halves, so that he can concentrate on one thing at a time."],
            ...
            .init(id: 16,
                  ...
                  description: """
                    ...
                    Explain the activity well, you can start by showing him what to do by doing it yourself.
                    ...
                    You can provide small reinforcement at the end of each bolt and big reinforcement at the end of the session.
                    """,
                  tips: ["We can increase the difficulty by increasing the number of pens and varying the types, mixing with markers, highlighters, and other different tools by color, size, and shape.", "This activity is also very useful for training the focus span. If the child is having trouble staying focused, start with a small number or pens, even just one. Then do the activity and reward him immediately after. Next time you can increase the number of pens."],
            ...
            .init(id: 17,
                  ...
                  description: """
                    ...
                    Start by explaining the activity well, demonstrate it first and then prompt the child physically until he can do it himself, always remember to intervene in case of errors.
            ...
            .init(id: 18,
                  ...
                  description: """
                    The purpose of the activity is to create strips of pushpins on the board with a certain color pattern, like red-yellow-red-yellow for example. To make it more easy, put the sheet of paper on the board and draw small circles where he will have to put the push pins

                    As usual, start by explaining the activity well, demonstrate it first and then prompt the child physically until he can do it himself, always remember to intervene in case of errors.
            ...
            .init(id: 19,
                  ...
                  description: """
                    ...
                    Start by explaining the activity well and then prompt the child physically until he can do it himselves, always remember to intervene in case of errors.
                    ...
                    """,
                  tips: ["Never leave the child alone with the pegs if there is the risk that he could ingest them."],
